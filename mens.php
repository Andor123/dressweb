...
<section class="container-fluid text-center" id="container2">
    <?php
    if (!isset($_SESSION["user"])) {
        ?>
    ...
    if (isset($_SESSION["user"])) {
        ...
        <div class="container-fluid">
            ...
            if (!isset($_SESSION["size"])) {
                ...
                <form method="post" action="filter1.php" id="filter" name="filter">
                    ...
                    <button type="submit" class="btn btn-primary" id="a1">Sort</button>
                </form><br>
                <?php
            }
            if (isset($_SESSION["size"])) {
                ?>
                <a class="btn btn-primary" id="a1" href="unset_filter1.php">Delete Sort</a><br><br>
                <?php
            }
            if (!isset($_SESSION["size"])) {
                $sql = "SELECT id, image, name, price FROM clothes WHERE category_id = 1";
                $result = mysqli_query($connection, $sql);
            }
            if (isset($_SESSION["size"])) {
                $size = $_SESSION["size"];
                $sql2 = "SELECT id, image, name, price FROM clothes WHERE category_id = 1 AND size = '$size'";
                    ...
                    <div class="row">
                        <div class="col">
                            <form method="post" action="buy.php" id="form" name="form">
                                ...
                                <button type="submit" class="btn btn-primary" id="a1">Buy</button>
                            </form>
                        </div>
                    </div>
                    <br>
